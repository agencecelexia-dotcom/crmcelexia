...
export function PortalLeadsKanbanPage() {
  ...
  return (
    <div>
      ...
      {/* Kanban view — HTML5 native DnD (desktop souris). Sur mobile/tactile,
          le drag est désactivé et on pousse l'utilisateur vers le menu ⋮
          de chaque card qui ouvre le picker de statut (parfaitement
          étiqueté + accessible clavier). Migration @dnd-kit prévue mais
          gelée tant que package-lock pas régénérable. */}
      {view === 'kanban' ? (

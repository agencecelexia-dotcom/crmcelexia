...
export function PortalInviteDialog({ client, open, onOpenChange, onSuccess }: Props) {
  ...
  const contractInfoReady = siren && nom && enseigne && formeJuridique
      ...
      <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        {step === 'email' && (
          <>
            ...
            <DialogFooter>
              <Button variant="ghost" onClick={() => setStep('contract_info')}>Retour</Button>
              <Button
                className="bg-violet-600 hover:bg-violet-700"
        ...
        {step === 'result' && inviteResult && (
          <>
            ...
            <DialogFooter>
              ...
              <Button className="bg-violet-600 hover:bg-violet-700" onClick={handleClose}>
                Fermer
              </Button>
            </DialogFooter>
          </>
